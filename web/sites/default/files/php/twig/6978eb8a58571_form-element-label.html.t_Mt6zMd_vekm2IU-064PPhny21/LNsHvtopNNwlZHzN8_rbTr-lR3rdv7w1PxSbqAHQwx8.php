...
class __TwigTemplate_1a667ae62e715802450903d78787516e extends Template
{
...
($context["title_display"] ?? null) == "invisible") &&  !($context["floating_label"] ?? null))) ? ("visually-hidden") : ("")), (((($tmp =         // line 20
...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["title_display", "floating_label", "required", "title", "attributes"]);        yield from [];
    }
