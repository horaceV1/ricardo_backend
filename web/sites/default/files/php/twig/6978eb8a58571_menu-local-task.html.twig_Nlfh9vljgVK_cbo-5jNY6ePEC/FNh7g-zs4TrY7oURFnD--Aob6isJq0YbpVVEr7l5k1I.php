...
class __TwigTemplate_39750a20d7dc36136bbef4ef1d7b61dd extends Template
{
  ...
  <a href=\"";
        ...
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($tmp = ($context["is_active"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("active") : ("")));
        yield "\">";
